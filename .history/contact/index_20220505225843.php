<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    if(count($errors) === 0) {
      ...
      header('Location: http://localhost:8888/HUD_LP4/contact/makesure.php');
...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="株式会社HHUUDD、HUD,ヒュード、株式会社HHUUDD_Web制作サイト、Web制作、ホームページ、ECサイト、CMSカスタマイズ、LP、CONTACT PAGE、コンタクトページ、お問い合わせ">
    <meta name="keywords" content="株式会社HHUUDD、HUD,ヒュード、株式会社HHUUDD_Web制作サイト、Web制作、ホームページ、ECサイト、CMSカスタマイズ、LP、CONTACT PAGE、コンタクトページ、お問い合わせ">
    ...
    <meta property="og:description" content="株式会社HHUUDD、HUD,ヒュード、株式会社HHUUDD_Web制作サイト、Web制作、ホームページ、ECサイト、CMSカスタマイズ、LP、CONTACT PAGE、コンタクトページ、お問い合わせ">
    <meta property="og:img" content="http://example.com/img/ogp.jpg">
  </head>
  ...
  <body>
    ...
    <main id="main">
      ...
      <div class="page-lead">
        <p class="sec-title-ja fadeIn">
          <span class="thx">
            HHUUDDにご興味を持っていただきありがとうございます。
          </span><br>
          ご相談、ご質問、料金のお見積りなど<br>
          お気軽にお問い合わせください。<br>
            ...
            <form id="form" action="index.php" method="POST" novalidate>
              <dl class="form-area">
                ...
                <div class="contact-form-group inputfield">
                  ...
                  <dd>
                    <input id="input-tel" class="input-text form-control form-text validate[custom[phone]]" type="tel" name="tel"  placeholder="xxxooooxxxx" required="required" data-error_placement="#tel_error" value="<?php if(isset($tel)) { echo $tel; } ?>">
                  </dd>
              ...
              <div class="makesurebox">
                <button class="btnstyle1 submitarea submit-btn right-arrow" type="submit" name="submit">確認</button>
              </div> 
    ...
    <!-- ↓エラーを起こしてるかも？ -->
    <!-- <script src="../php_form_HUD/js/jquery.validationEngine-en.js" type="text/javascript" charset="utf-8"></script> -->
