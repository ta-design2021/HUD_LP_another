    ...
    <div class="SiteWrapper">
      ...
      <main id="main">
        <div class="hero contact-hero">
          ...
          <div class="first-view-ttl wrapper fadeIn">
            <div class="first-view-txt">
              <h2 class="site-ttl">
                Webサイト制作で課題の<br>
                解決をいたします
              </h2>
              <p class="site-sub-ttl">~ The problem will be solved by creating a website. ~</p>
            </div>
          </div> <!-- /.first-view -->
          <div class="lead">
            <p>
              <span>「オモイ」をデザインする</span><br>
              あなたの思いや、伝えたいことを形にして伝える。<br>
              それが私たちHHUUDDです。
            </p>
          </div>
        </div>
