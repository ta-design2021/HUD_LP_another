            ...
            <form id="form" action="commit.php" method="post">
              ...
              <div class="send-btn">
                <div class="backandsendbox">
                  <button class="btnStyle1 sendBtnArea submit-btn right-arrow" type="submit">送信</button>
                  <a class="btnStyle1 backBtnArea mgb10px submit-btn back-btn" href="index.php?action=edit">戻る</a>
                </div>  
              </div>
